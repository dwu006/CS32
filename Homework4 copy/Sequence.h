...
int subsequence(const Sequence<T>& seq1, const Sequence<T>& seq2);
      ...
      template <typename T>
void zipper(const Sequence<T>& seq1, const Sequence<T>& seq2, Sequence<T>& result);
      // Set result to contain elements alternately from seq1 and seq2
...
void zipper(const Sequence<T>& seq1, const Sequence<T>& seq2, Sequence<T>& result)
{
    ...
    Sequence<T> res;
      ...
      // Insert elements alternately from seq1 and seq2 until one or both
      // sequences run out.
